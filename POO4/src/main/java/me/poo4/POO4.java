...
public class POO4 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("El perimetro del rectángulo 1 es: "
                + ServiceRectangulo.perimetro(rectangulo1));
        System.out.println("La superficie del rectángulo 1 es: "
                + ServiceRectangulo.superficie(rectangulo1));
